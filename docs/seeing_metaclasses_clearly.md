...
source: (http://whytheluckystiff.net/articles/seeingMetaclassesClearly.html)
...
To get rid of the extend ClassMethods you can take advantage of the included callback and rewrite to:
...
source: (http://macournoyer.wordpress.com/2007/07/06/extending-your-include-knowledge-of-ruby/)
