...
values."
  (setq-default
   ...
   '(
     ...
     ;; rcirc
     ;; --- Custom
     ;; Flow-type from: https://github.com/awesomejerry/.spacemacs.d/tree/master/layers/flow-type
     ;; flow-type
     ;; (flow-type :variables flow-type-no-auto-start t
...
you should place your code here."
  ...
  ;; >>>>   "A coverage checker for Flow. See URL `http://flowtype.org/'."
  ;; >>>>   :command (
  ;; >>>>             "flow"
  ;; >>>>             "coverage"
  ;; >>>>             (eval flycheck-javascript-flow-args)
