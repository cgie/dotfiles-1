...
you should place your code here."
  ...
  ;;;; Javascript mode
  ;;    (flycheck-define-checker javascript-flow
  ;;      "A JavaScript syntax and style checker using Flow (http://flowtype.org/)."
